...
folders = ["../dataset_sing_top/evalRes_NEW_EliBackbone/EVALUATE/","../dataset_sing_top/evalRes_NEW_Janetbackbone/EVALUATE/","../dataset_sing_top/evalRes_NEW_HurricaneElectric/EVALUATE/"]
...
if __name__ == "__main__":
    ...
    for folder in folders:
        ...
        topology_eval_name = folder.split('_')[4].split('/')[0]
